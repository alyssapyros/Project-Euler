...
all_cards=all_cards.strip()
all_hands=all_cards.split('\n')
# print all_hands
...
# for i in all_hands[0]:
# 	print i

c=0
all_hands_with_numbers=[]
while c < len(all_hands):
	new_list=[]
	for i in all_hands[c]:
		if i == 'K':
			i=i.replace('K','10')
			new_list.append(i)
		elif i == 'Q':
			...
			new_list.append(i)
	all_hands_with_numbers.append(new_list)
	c+=1

print all_hands_with_numbers

highest_in_hand=[]

n=0

while n < len(all_hands_with_numbers):
	highest_number = 0
	for card in all_hands_with_numbers[n]:
		if card in ('D','S','H','C',','):
			pass  
		else:
			if int(card) > highest_number:
				highest_number = int(card)
	highest_number=str(highest_number)
	index=all_hands_with_numbers[n].index(highest_number)
	suit = all_hands_with_numbers[n][index+1]
	highest_card = highest_number+ suit
	print highest_card
	# 	print card
	n+=1
